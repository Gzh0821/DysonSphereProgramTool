        ...
        var data = [
            {
                ...
                //m ： 生产设备
                //t ： 生产时间(秒)
				//noExtra : 提供true增产剂只允许加速 (如果不提供就是false)
                s: [{ name: "宇宙矩阵" }], q:
                    [
                        { name: "蓝矩阵", n: 1 },
                        { name: "红矩阵", n: 1 },
            ...
            {
                s: [{ name: "量子化工厂", n: 1 }], group: "建筑", m: "制作台", q: [
                    { name: "化工厂", n: 1 },
                    { name: "钛化玻璃", n: 10 },
                    { name: "奇异物质", n: 3 },
                    { name: "量子芯片", n: 3 }
            ...
            {
                s: [{ name: "物流配送器", n: 1 }], group: "建筑", m: "制作台", q: [
                    { name: "铁块", n: 8 },
                    { name: "电浆激发器", n: 4 },
                    { name: "处理器", n: 4 }
                ], t: 8
            ...
            {
                s: [{ name: "配送运输机", n: 1 }], group: "组件", m: "制作台", q: [
                    { name: "铁块", n: 2 },
                    { name: "电磁涡轮", n: 1 },
                    { name: "处理器", n: 1 }
                ], t: 2
